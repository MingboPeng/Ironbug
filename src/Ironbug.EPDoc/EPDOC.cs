...
";
	public static string Field_Name = @"A unique user-assigned name for an instance of a cooling coil. Any reference to this cooling coil by another object will use this name.";
		...
		public static string Field_DesignInletWaterTemperature = @"The inlet water temperature for the design flow (C). This is an auto sizable design input.";
		public static string Field_DesignInletAirTemperature = @"The inlet air temperature for the design flow (C). This is an auto sizable design input.";
		public static string Field_DesignOutletAirTemperature = @"The outlet air condition desired for design flow (C). This is an auto sizable design input.";
		public static string Field_DesignInletAirHumidityRatio = @"The highest value of humidity ratio possible for the Design inlet air stream (kgWater/kgDryAir). This is an auto sizable input.";
		public static string Field_DesignOutletAirHumidityRatio = @"The value of humidity ratio for the Design outlet air stream (kgWater/kgDryAir), it is an auto sizable input.";
		public static string Field_WaterInletNodeName = @"The name of the water coil inlet from the chilled water loop, i.e.~Cooling Coil Water Inlet Node. It is from this node the operating inputs for water are transferred to the coil.";
		public static string Field_WaterOutletNodeName = @"The name of the water coil outlet from the chilled water loop, i.e.~Cooling Coil Water Outlet Node. It is from this node the operating output for water are reported to the coil.";
		public static string Field_AirInletNodeName = @"The name of the air inlet to the water coil, i.e.~Cooling Coil Air Inlet Node. It is from this node the operating inputs for air are transferred to the coil.";
		public static string Field_AirOutletNodeName = @"The name of the air outlet from the water coil, i.e.~Cooling Coil Air Outlet Node. It is from this node the operating output for airside is reported to the coil.";
		public static string Field_TypeOfAnalysis = @"The coil has two modes of operation, termed as {SimpleAnalysis} and {DetailedAnalysis}. The difference between the two modes being, the simple mode reports the value of surface area fraction wet of the coil as dry or wet. The detailed mode give the exact value, however the execution time in detailed mode is noticeably higher.";
		public static string Field_HeatExchangerConfiguration = @"The coil is operable in two configurations: {CounterFlow} or {CrossFlow}. Chilled water coils are generally built as counter-flow. The default is CounterFlow..";
		public static string Field_CondensateCollectionWaterStorageTankName = @"This field is optional. It is used to describe where condensate from the coil is collected. If blank or omitted, then any coil condensate is discarded. Enter the name of Water Storage Tank object defined elsewhere and the condensate will then be collected in that tank.";
		public static string Field_DesignWaterTemperatureDifference = @"This input field is optional. If specified, it is used for sizing the {Design Water Flow Rate}. If blank or omitted, the {Loop Design Temperature Difference} value specified in {Sizing:Plant} object is used for sizing the {Design Water Flow Rate}.
...
where q is the heat transferred from water to the air in watts; T_{water,\\ avg} is the average water temperature in degrees C; and T_{air,\\ avg} is the average air temperature in degrees C. Or the LMTD temperature difference can be used. This field is used when {Performance Input Method} = {UFactorTimesAreaAndDesignWaterFlowRate}.This field is autosizable.";
		public static string Field_MaximumWaterFlowRate = @"The maximum possible water flow rate (m^{3}/sec) through the coil. This field is used when {Coil Performance Input Method} = {UFactorTimesAreaAndDesignWaterFlowRate}. This field is autosizable.";
		public static string Field_WaterInletNodeName = @"The name of the coil s water inlet node from the hot water loop.";
		public static string Field_WaterOutletNodeName = @"The name of the coil s water outlet node from the hot water loop.";
		public static string Field_AirInletNodeName = @"The name of the air inlet node to the water coil.";
		public static string Field_AirOutletNodeName = @"The name of the air outlet node from the water coil.";
		public static string Field_PerformanceInputMethod = @"The user can choose either {UFactorTimesAreaAndDesignWaterFlowRate} or {NominalCapacity}. If {UFactorTimesAreaAndDesignWaterFlowRate} is selected, the user must input values for UA of the Coil and Max Water FlowRate of the Coil (and Rated Capacity is ignored). If {NominalCapacity} is chosen, the user must input a Rated Capacity for the coil; UA of the Coil and Max Water FlowRate of the Coil will be ignored. Rated capacity is defined as the heating capacity in watts of the coil at the rating points (i.e., the rated inlet and outlet water/air temperatures defined in the input fields below). The rated capacity is used to calculate a water mass flow rate and a UA for the coil. The default is {NominalCapacity}.
...
To autosize the capacity, choose {UfactorTimesAreaAndDesignWaterFlowRate} and put autosize as the inputs for {U-Factor Times Area Value, Maximum Water Flow Rate,} and {Rated Capacity}. The program will use the Sizing inputs to size the coil. The rated temperatures (see below) are ignored in autosizing. These are used only when the user is specifying coil performance using the {NominalCapacity} input method.";
		public static string Field_GrossRatedHeatingCapacity = @"The heating capacity of the coil in watts at the rated inlet and outlet air and water temperatures. The gross rated heating capacity does not account for the effect of supply air fan heat. This field is used when the {Performance Input Method} = {Nominal Capacity}. This field is autosizable. The rating points are given in the four subsequent input fields.";
		public static string Field_RatedInletWaterTemperature = @"The inlet water temperature (degrees C) corresponding to the rated heating capacity. The default is 82.2 degrees C (180 degrees F).";
		public static string Field_RatedInletAirTemperature = @"The inlet air temperature (degrees C) corresponding to the rated heating capacity. The default is 16.6 degrees C (60 degrees F).";
		public static string Field_RatedOutletWaterTemperature = @"The outlet water temperature (degrees C) corresponding to the rated heating capacity. The default is 71.1 degrees C (160 degrees F).";
		public static string Field_RatedOutletAirTemperature = @"The outlet air temperature (degrees C) corresponding to the nominal heating capacity. The default is 32.2 degrees C (90 degrees F).";
		public static string Field_RatedRatioForAirAndWaterConvection = @"This is the ratio of convective heat transfers between air side and water side of the heating coil at the rated operating conditions. The default is .5. This ratio describes the geometry and the design of the coil and is defined by:
...
";
	public static string Field_Name = @"A unique identifying name for each steam coil.";
		...
		public static string Field_DegreeOfLoopSubCooling = @"This essentially represents the heat loss to the atmosphere due to uninsulated condensate return piping to the boiler. Condensate return piping operates at atmospheric pressure and is not insulated. The condensate sub cools to certain degree before it is pumped back to the boiler. The minimum value is 10 ?? Celsius and default is 20 ?? Celsius.";
		public static string Field_WaterInletNodeName = @"The name of the steam coil inlet from the steam loop, i.e.~Steam Coil steam inlet node.";
		public static string Field_WaterOutletNodeName = @"The name of the steam coil outlet to the condensate loop, i.e.~Steam Coil condensate outlet node.";
		public static string Field_AirInletNodeName = @"The name of the air inlet to the steam coil, i.e.~Steam Coil Air Inlet Node.";
		public static string Field_AirOutletNodeName = @"The name of the air outlet from the steam coil, i.e.~Steam Coil Air Outlet Node.";
		public static string Field_CoilControlType = @"Choice of either {ZoneLoadControl} steam coil or {TemperatureSetpointControl} steam coil. A zone coil is load controlled and an air loop steam coil is temperature controlled.";
		public static string Field_TemperatureSetpointNodeName = @"If the coil is used in the air loop simulation and is temperature controlled using a Set Point Manager (i.e., the previous file is TemperatureSetpointConrtol), then the node that is the control node needs to be specified here. If the coil is used in an air terminal unit, the coil is load controlled and a control node set point is not required (i.e., the previous field is ZoneLoadControl).
...
";
	public static string Field_Name = @"A unique identifying name for each coil.";
		...
		public static string Field_Stage1Efficiency = @"This is stage 1 user-inputted efficiency (decimal units, not percent) and can account for any loss. In most cases for the electric coil, this will be 100%.";
		public static string Field_Stage1NominalCapacity = @"This is stage 1 capacity of the coil (W). This field is autosizable.";
		public static string Field_Stage2Efficiency = @"This is stage 2 user-inputted efficiency (decimal units, not percent) and can account for any loss. In most cases for the electric coil, this will be 100%.";
		public static string Field_Stage2NominalCapacity = @"This is stage 2 capacity of the coil (W). This field is autosizable.";
		public static string Field_Stage3Efficiency = @"This is stage 3 user-inputted efficiency (decimal units, not percent) and can account for any loss. In most cases for the electric coil, this will be 100%.";
		public static string Field_Stage3NominalCapacity = @"This is stage 3 capacity of the coil (W). This field is autosizable.";
		public static string Field_Stage4Efficiency = @"This is stage 4 user-inputted efficiency (decimal units, not percent) and can account for any loss. In most cases for the electric coil, this will be 100%.";
		public static string Field_Stage4NominalCapacity = @"This is stage 4 capacity of the coil (W). This field is autosizable.
...
";
	public static string Field_Name = @"This alpha field defines a unique user-assigned name for an instance of a desuperheater heating coil. Any reference to this desuperheater heating coil by another object will use this name.";
		...
		public static string Field_AirOutletNodeName = @"This alpha field defines the name of the HVAC system node to which the desuperheater heating coil sends its outlet air.";
		public static string Field_HeatingSourceObjectType = @"This alpha field defines the source of superheated refrigerant gas from which the desuperheater heating coil recovers energy. Valid choices are:
...
NOTE: Use of the desuperheater heating coil in variable air volume systems should be done with caution since the model assumption of a fixed heat reclaim recovery efficiency may not be valid if the air flow rate over the coil varies significantly.";
		public static string Field_HeatingSourceName = @"This alpha field defines the name of the desuperheater heating coil source (e.g., the name of a specific valid coil (as mentioned in the previous field) which provides waste heat to this desuperheater heating coil).
...
";
	public static string Field_Name = @"A unique identifying name for each coil.";
		...
		public static string Field_NominalCapacity = @"This is the maximum capacity of the coil (W). This controlled coil will only provide the needed capacity to meet the control criteria whether it is temperature or capacity controlled. This field is autosizable.";
		public static string Field_AirInletNodeName = @"The name of the air inlet to the coil, i.e.~Heating Coil Air Inlet Node.";
		public static string Field_AirOutletNodeName = @"The name of the air outlet from the coil, i.e.~Heating Coil Air Outlet Node.";
		public static string Field_TemperatureSetpointNodeName = @"If the coil is used in the air loop simulation and is temperature controlled using a Set Point Manager, then the node that is the control node needs to be specified here. If the coil is used in an air terminal unit, the coil is load controlled and a control node set point is not required.";
...
A typical part load fraction correlation for a conventional gas heating coil (e.g., residential furnace) would be:
       ...
       PLF = 0.8 + 0.2(PLR)";
		public static string Field_ParasiticGasLoad = @"This numeric field is the parasitic gas load associated with the gas coil s operation (Watts), such as a standing pilot light. The model assumes that this parasitic load is consumed only for the portion of the simulation timestep where the gas heating coil is not operating.";
		public static string Field_Stage1GasBurnerEfficiency = @"This is user inputted stage 1 gas burner efficiency (decimal, not percent) and is defaulted to 80%.";
		public static string Field_Stage1NominalCapacity = @"This is the stage 1 capacity of the coil (W). This controlled coil will only provide the needed capacity to meet the control criteria whether it is temperature or capacity controlled. This field is autosizable.";
		public static string Field_Stage1ParasiticElectricLoad = @"This is the stage 1 parasitic electric load associated with the gas coil operation, such as an inducer fan, etc.. This will be modified by the PLR (or coil runtime fraction if a part-load fraction correlation is provided in the next input field) to reflect the time of operation in a simulation timestep.";
		public static string Field_Stage2GasBurnerEfficiency = @"This is user inputted stage 2 gas burner efficiency (decimal, not percent) and is defaulted to 80%.";
		public static string Field_Stage2NominalCapacity = @"This is the stage 2 capacity of the coil (W). This controlled coil will only provide the needed capacity to meet the control criteria whether it is temperature or capacity controlled. This field is autosizable.";
		public static string Field_Stage2ParasiticElectricLoad = @"This is the stage 2 parasitic electric load associated with the gas coil operation, such as an inducer fan, etc.. This will be modified by the PLR (or coil runtime fraction if a part-load fraction correlation is provided in the next input field) to reflect the time of operation in a simulation timestep.";
		public static string Field_Stage3GasBurnerEfficiency = @"This is user inputted stage 3 gas burner efficiency (decimal, not percent) and is defaulted to 80%.";
		public static string Field_Stage3NominalCapacity = @"This is the stage 3 capacity of the coil (W). This controlled coil will only provide the needed capacity to meet the control criteria whether it is temperature or capacity controlled. This field is autosizable.";
		public static string Field_Stage3ParasiticElectricLoad = @"This is the stage 3 parasitic electric load associated with the gas coil operation, such as an inducer fan, etc.. This will be modified by the PLR (or coil runtime fraction if a part-load fraction correlation is provided in the next input field) to reflect the time of operation in a simulation timestep.";
		public static string Field_Stage4GasBurnerEfficiency = @"This is user inputted stage 4 gas burner efficiency (decimal, not percent) and is defaulted to 80%.";
		public static string Field_Stage4NominalCapacity = @"This is the stage 4 capacity of the coil (W). This controlled coil will only provide the needed capacity to meet the control criteria whether it is temperature or capacity controlled. This field is autosizable.";
		public static string Field_Stage4ParasiticElectricLoad = @"This is the stage 4 parasitic electric load associated with the gas coil operation, such as an inducer fan, etc.. This will be modified by the PLR (or coil runtime fraction if a part-load fraction correlation is provided in the next input field) to reflect the time of operation in a simulation timestep.
...
";
	public static string Field_Name = @"A unique identifying name for each coil.";
		...
		public static string Field_TotalTubeInsideArea = @"The total surface area (m^{2}) inside the tubes (water side).";
		public static string Field_FinSurfaceArea = @"The total surface area (m^{2}) of the fins attached to the coil.";
		public static string Field_MinimumAirFlowArea = @"The minimum cross sectional area (m^{2}) available for air passage. Frequently calculated as
...
where Afr is the frontal area of the heat exchanger, and (Amin/Afr) is the ratio of the minimum airflow area to frontal area.";
		public static string Field_CoilDepth = @"The distance (m) from the front of the coil to the back of the coil in the airflow direction. Also called the fin depth. Illustrated in the figure (Figure~\ref{fig:geometry-of-a-cooling-coil-cc}. Geometry of a Cooling Coil (CC)).";
		public static string Field_FinDiameter = @"The outside diameter (m) of the fins. Used instead of COIL HEIGHT";
		public static string Field_FinThickness = @"Thickness (m) of the air side fins.";
		public static string Field_TubeInsideDiameter = @"The inside diameter (m) of the tubes.";
		public static string Field_TubeOutsideDiameter = @"The outside diameter (m) of the tubes.";
		public static string Field_TubeThermalConductivity = @"The thermal conductivity (W/m-K) of the tube material.";
		public static string Field_FinThermalConductivity = @"The thermal conductivity (W/m-K) of the fin material.";
		public static string Field_FinSpacing = @"The spacing (m) of the fins, centerline to centerline.";
		public static string Field_TubeDepthSpacing = @"The spacing (m) of the tube rows, centerline to centerline. Also called tube longitudinal spacing.";
		public static string Field_NumberOfTubeRows = @"The number of tube rows in the direction of the airflow.";
		public static string Field_NumberOfTubesPerRow = @"The number of tubes per row. (NTPR in the above diagram)";
		public static string Field_WaterInletNodeName = @"The name of the water coil inlet from the chilled water loop, i.e.~Cooling Coil Water Inlet Node.";
		public static string Field_WaterOutletNodeName = @"The name of the water coil outlet from the chilled water loop, i.e.~Cooling Coil Water Outlet Node.";
		public static string Field_AirInletNodeName = @"The name of the air inlet to the water coil, i.e.~Cooling Coil Air Inlet Node.";
		public static string Field_AirOutletNodeName = @"The name of the air outlet from the water coil, i.e.~Cooling Coil Air Outlet Node.";
		public static string Field_CondensateCollectionWaterStorageTankName = @"This field is optional. It is used to describe where condensate from the coil is collected. If blank or omitted, then any coil condensate is discarded. Enter the name of Water Storage Tank object defined elsewhere and the condensate will then be collected in that tank.";
		public static string Field_DesignWaterTemperatureDifference = @"This input field is optional. If specified, it is used for sizing the {Design Water Flow Rate}. If blank or omitted, the {Loop Design Temperature Difference} value specified in {Sizing:Plant} object is used for sizing the {Design Water Flow Rate}.
...
If the user wishes to model no efficiency degradation due to compressor cycling, the part load fraction correlation should be defined as follows:
       ...
       PLF = 1.0 + 0.0(PLR)";
		public static string Field_MinimumOutdoorDryBulbTemperatureForCompressorOperation = @"This numeric field defines the minimum outdoor air dry-bulb temperature where the cooling coil compressor turns off. If this input field is left blank, the default value is -25 ??C.";
		public static string Field_NominalTimeForCondensateRemovalToBegin = @"The nominal time (in seconds) after startup for condensate to begin leaving the coil's condensate drain line at the coil's rated airflow and temperature conditions, starting with a dry coil. Nominal time is equal to the ratio of the energy of the coil's maximum condensate holding capacity (J) to the coil's steady-state latent capacity (W). Suggested value is 1000; zero value means the latent degradation model is disabled. The default value for this field is zero. The supply air fan operating mode must be continuous (i.e., the supply air fan operating mode may be specified in other parent objects and is assumed continuous in some objects (e.g., CoilSystem:Cooling:DX) or can be scheduled in other objects [e.g., AirloopHVAC:UnitaryHeatCool]), and this field as well as the next three input fields for this object must have positive values in order to model latent capacity degradation.";
		public static string Field_RatioOfInitialMoistureEvaporationRateAndSteadyStateLatentCapacity = @"Ratio of the initial moisture evaporation rate from the cooling coil (when the compressor first turns off, in Watts) and the coil's steady-state latent capacity (Watts) at rated airflow and temperature conditions. Suggested value is 1.5; zero value means the latent degradation model is disabled. The default value for this field is zero. The supply air fan operating mode must be continuous (i.e., the supply air fan operating mode may be specified in other parent objects and is assumed continuous in some objects (e.g., CoilSystem:Cooling:DX) or can be scheduled in other objects [e.g., AirloopHVAC:UnitaryHeatCool]); and this field, the previous field and the next two fields must have positive values in order to model latent capacity degradation.";
		public static string Field_MaximumCyclingRate = @"The maximum on-off cycling rate for the compressor (cycles per hour), which occurs at 50% run time fraction. Suggested value is 3; zero value means latent degradation model is disabled. The default value for this field is zero. The supply air fan operating mode must be continuous (i.e., the supply air fan operating mode may be specified in other parent objects and is assumed continuous in some objects (e.g., CoilSystem:Cooling:DX) or can be scheduled in other objects [e.g., AirloopHVAC:UnitaryHeatCool]); and this field, the previous two fields and the next field must have positive values in order to model latent capacity degradation.";
		public static string Field_LatentCapacityTimeConstant = @"Time constant (in seconds) for the cooling coil's latent capacity to reach steady state after startup. Suggested value is 45: supply air fan operating mode must be continuous. That is, the supply air fan operating mode may be specified in other parent objects and is assumed continuous in some objects (e.g., CoilSystem:Cooling:DX) or can be scheduled in other objects (e.g., AirloopHVAC:UnitaryHeatCool), and this field as well as the previous three input fields for this object must have positive values in order to model latent capacity degradation.";
		public static string Field_CondenserAirInletNodeName = @"This optional alpha field specifies the outdoor air node name used to define the conditions of the air entering the outdoor condenser. If this field is left blank, the outdoor air temperature entering the condenser (dry-bulb or wet-bulb) is taken directly from the weather data. If this field is not blank, the node name specified must also be specified in an OutdoorAir:Node object where the height of the node is taken into consideration when calculating outdoor air temperature from the weather data. Alternately, the node name may be specified in an OutdoorAir:NodeList object where the outdoor air temperature is taken directly from the weather data.";
		public static string Field_CondenserType = @"The type of condenser used by the DX cooling coil. Valid choices for this input field are {AirCooled} or {EvaporativelyCooled}. The default for this field is {AirCooled}.";
		public static string Field_EvaporativeCondenserEffectiveness = @"The effectiveness of the evaporative condenser, which is used to determine the temperature of the air entering the outdoor condenser coil as follows:
...
If the user wishes to model no efficiency degradation due to compressor cycling, the part load fraction correlation should be defined as follows:
       ...
       PLF = 1.0 + 0.0(PLR)";
		public static string Field_LowSpeedGrossRatedTotalCoolingCapacity = @"The total, full load gross total cooling capacity (sensible plus latent) in watts of the DX coil unit for low speed compressor and low speed fan at rated conditions (air entering the cooling coil at 26.7 ??C drybulb/19.4 ??C wetbulb, air entering the outdoor condenser coil at 35 ??C drybulb/23.9 ??C wetbulb, and a cooling coil air flow rate defined by field rated air flow rate, low speed below). Capacity should be gross (i.e., the effect of supply air fan heat is NOT accounted for).";
		public static string Field_LowSpeedGrossRatedSensibleHeatRatio = @"The sensible heat ratio (SHR = gross sensible capacity divided by gross total cooling capacity) of the DX cooling coil for low speed compressor and low speed fan at rated conditions (air entering the cooling coil at 26.7 ??C drybulb/19.4 ??C wetbulb, air entering the outdoor condenser coil at 35 ??C drybulb/23.9 ??C wetbulb, and a cooling coil air flow rate defined by field rated air flow rate, low speed below). Both the sensible and total cooling capacities used to define the Rated SHR should be gross (i.e., the effect of supply air fan heat is NOT accounted for).";
		public static string Field_LowSpeedGrossRatedCoolingCOP = @"The coefficient of performance is the ratio of gross total cooling capacity in watts to electrical power input in watts) of the DX cooling coil unit for low speed compressor and low speed fan at rated conditions (air entering the cooling coil at 26.7 ??C drybulb/19.4 ??C wetbulb, air entering the outdoor condenser coil at 35 ??C drybulb/23.9 ??C wetbulb, and a cooling coil air flow rate defined by field rated air volume flow rate, low speed below). The input power includes power for the compressor(s) and condenser fan(s) but does not include the power consumption of the supply air fan. The gross COP should NOT account for the supply air fan. If this input field is left blank, the default value is 3.0.";
		public static string Field_LowSpeedRatedAirFlowRate = @"The low speed volume air flow rate, in m^{3} per second, across the DX cooling coil at rated conditions. The rated air volume flow rate should be between 0.00004027 m^{3}/s and 0.00006041 m^{3}/s per watt of the gross rated total cooling capacity. For DOAS applications the rated air volume flow rate should be between 0.00001677 m^{3}/s and 0.00003355 m^{3}/s per watt of gross rated total cooling capacity (125 to 250 cfm/ton). The gross rated total cooling capacity, gross rated SHR and gross rated COP should be performance information for the unit with air entering the cooling coil at 26.7 ??C drybulb/19.4 ??C wetbulb, air entering the outdoor condenser coil at 35 ??C drybulb/23.9 ??C wetbulb, and the rated air volume flow rate defined here.";
		public static string Field_LowSpeedTotalCoolingCapacityFunctionOfTemperatureCurveName = @"The name of a biquadratic performance curve (ref: Performance Curves) that parameterizes the variation of the gross total cooling capacity as a function of the wet-bulb temperature of the air entering the cooling coil, and the dry-bulb temperature of the air entering the air-cooled condenser (wet-bulb temperature if modeling an evaporative-cooled condenser). The output of this curve is multiplied by the gross rated total cooling capacity to give the gross total cooling capacity at specific temperature operating conditions (i.e., at temperatures different from the rating point temperatures). The curve is normalized to have the value of 1.0 at the rating point. This curve is used for performance at the low speed compressor, low speed fan operating point.";
		public static string Field_LowSpeedEnergyInputRatioFunctionOfTemperatureCurveName = @"The name of a biquadratic performance curve (ref: Performance Curves) that parameterizes the variation of the energy input ratio (EIR) as a function of the wetbulb temperature of the air entering the cooling coil and the drybulb temperature of the air entering the air-cooled condenser (wetbulb temperature if modeling an evaporative-cooled condenser). The EIR is the inverse of the COP. The output of this curve is multiplied by the rated EIR (inverse of rated COP) to give the EIR at specific temperature operating conditions (i.e., at temperatures different from the rating point temperatures). The curve is normalized to a value of 1.0 at the rating point. This curve is used for performance at the low speed compressor, low speed fan operating point.";
		public static string Field_CondenserAirInletNodeName = @"This optional alpha field specifies the outdoor air node name used to define the conditions of the air entering the outdoor condenser. If this field is left blank, the outdoor air temperature entering the condenser (dry-bulb or wet-bulb) is taken directly from the weather data. If this field is not blank, the node name specified must also be specified in an OutdoorAir:Node object where the height of the node is taken into consideration when calculating outdoor air temperature from the weather data. Alternately, the node name may be specified in an OutdoorAir:NodeList object where the outdoor air temperature is taken directly from the weather data.";
		public static string Field_CondenserType = @"The type of condenser used by the multi-speed DX cooling coil. Valid choices for this input field are {AirCooled} or {EvaporativelyCooled}. The default for this field is {AirCooled}.";
		public static string Field_MinimumOutdoorDryBulbTemperatureForCompressorOperation = @"This numeric field defines the minimum outdoor air dry-bulb temperature where the cooling coil compressor turns off. If this input field is left blank, the value defaults to that specified in the IDD (e.g., -25 ??C). If this field is not included in the input, the default value is -25 ??C.";
		public static string Field_HighSpeedEvaporativeCondenserEffectiveness = @"The effectiveness of the evaporative condenser at high compressor/fan speed, which is used to determine the temperature of the air entering the outdoor condenser coil as follows:
...
The resulting condenser inlet air temperature is used by the Total Cooling Capacity Modifier Curve, low speed (function of temperature) and the Energy Input Ratio Modifier Curve, low speed (function of temperature). The default value for this field is 0.9, although valid entries can range from 0.0 to 1.0. This field is not used when Condenser Type = Air Cooled. See field Evaporative Condenser Effectiveness, High Speed above for further information.";
		...
		public static string Field_SensibleHeatRatioFunctionOfTemperatureCurveName = @"The name of a biquadratic normalized curve (Ref: Performance Curves) that parameterizes the variation of the sensible heat ratio (SHR) as a function of DX cooling coil entering air wet-bulb and dry-bulb temperatures. The output of this curve is multiplied by the rated SHR and the SHR modifier curve (function of flow fraction) to give the SHR at the specific coil entering air temperature and air flow conditions at which the cooling coil is operating. This curve is normalized to a value of 1.0 at the rated condition. This input field is optional.";
		public static string Field_SensibleHeatRatioFunctionOfFlowFractionCurveName = @"The name of a quadratic or cubic normalized curve (Ref: Performance Curves) that parameterizes the variation of the sensible heat ratio (SHR) as a function of the ratio of actual air flow rate across the cooling coil to the rated air flow rate (i.e., fraction of full load flow). The output of this curve is multiplied by the rated SHR and the SHR modifier curve (function of temperature) to give the SHR at the specific temperature and air flow conditions at which the cooling coil is operating. This curve is normalized to a value of 1.0 when the actual air flow rate equals the rated air flow rate. This input field is optional.";
		public static string Field_LowSensibleHeatRatioFunctionOfTemperatureCurveName = @"The name of a biquadratic normalized curve (Ref: Performance Curves) that parameterizes the variation of the sensible heat ratio (SHR) as a function of DX cooling coil entering air wet-bulb and dry-bulb temperatures. The output of this curve is multiplied by the rated SHR and the SHR modifier curve (function of flow fraction) to give the SHR at the specific coil entering air temperature and air flow conditions at which the cooling coil is operating. This curve is normalized to a value of 1.0 at the rated condition. This input field is optional.";
		public static string Field_LowSensibleHeatRatioFunctionOfFlowFractionCurveName = @"The name of a quadratic or cubic normalized curve (Ref: Performance Curves) that parameterizes the variation of the sensible heat ratio (SHR) as a function of the ratio of actual air flow rate across the cooling coil to the rated air flow rate (i.e., fraction of full load flow). The output of this curve is multiplied by the rated SHR and the SHR modifier curve (function of temperature) to give the SHR at the specific temperature and air flow conditions at which the cooling coil is operating. This curve is normalized to a value of 1.0 when the actual air flow rate equals the rated air flow rate. This input field is optional.";
		public static string Field_ZoneNameForCondenserPlacement = @"This input field is name of a conditioned or unconditioned zone where the secondary coil (condenser) of DX system or a heat pump is to be placed. This is an optional input field specified only when user desires to reject the condenser heat into a zone. The heat rejected is modeled as sensible internal gain of a secondary zone.
...
";
	public static string Field_Name = @"This alpha field is a unique user-assigned name for an instance of DX cooling coil performance. Any reference to this DX coil performance object by another object will use this name.";
		...
		public static string Field_TotalCoolingCapacityFunctionOfFlowFractionCurveName = @"The name of a {quadratic} or {cubic} performance curve (ref: Performance Curves) that parameterizes the variation of the gross total cooling capacity as a function of the ratio of actual air flow rate across the cooling coil to the rated air flow rate (i.e., fraction of full load flow). The output of this curve is multiplied by the gross rated total cooling capacity and the total cooling capacity modifier curve (function of temperature) to give the gross total cooling capacity at the specific temperature and air flow conditions at which the coil is operating. The curve is normalized to have the value of 1.0 when the actual air flow rate equals the rated air flow rate.";
		public static string Field_EnergyInputRatioFunctionOfTemperatureCurveName = @"The name of a {biquadratic} performance curve (ref: Performance Curves) that parameterizes the variation of the energy input ratio (EIR) as a function of the wet-bulb temperature of the air entering the cooling coil, and the dry-bulb temperature of the air entering the air-cooled condenser coil (wet-bulb temperature if modeling an evaporative-cooled condenser). The EIR is the inverse of the COP. The output of this curve is multiplied by the rated EIR (inverse of rated COP) to give the EIR at specific temperature operating conditions (i.e., at temperatures different from the rating point temperatures). The curve is normalized to a value of 1.0 at the rating point.";
...
";
	public static string Field_Name = @"This alpha field defines a unique user-assigned name for an instance of a multispeed DX heating coil. Any reference to this DX heating coil by another object will use this name. The only allowed parent is AirLoopHVAC:UnitaryHeatPump:AirToAir:MultiSpeed.";
		...
		public static string Field_AirInletNodeName = @"This alpha field defines the name of the HVAC system node from which the DX heating coil draws its inlet air.";
		public static string Field_AirOutletNodeName = @"This alpha field defines the name of the HVAC system node to which the DX heating coil sends its outlet air.";
		public static string Field_MinimumOutdoorDryBulbTemperatureForCompressorOperation = @"This numeric field defines the minimum outdoor air dry-bulb temperature where the heating coil compressor turns off. If this input field is left blank, the default value is -8 ??C.";
		public static string Field_CrankcaseHeaterCapacity = @"This numeric field defines the crankcase heater capacity in Watts. When the outdoor air dry-bulb temperature is below the value specified in the input field Maximum Outdoor Dry-bulb Temperature for Crankcase Heater Operation (described below), the crankcase heater is enabled during the time that the compressor is not running. The value for this input field must be greater than or equal to 0. If this input field is left blank, the default value is 0. To simulate a unit without a crankcase heater, enter a value of 0.";
		public static string Field_MaximumOutdoorDryBulbTemperatureForCrankcaseHeaterOperation = @"This numeric field defines the outdoor air dry-bulb temperature above which the compressor s crankcase heater is disabled. The value for this input field must be greater than or equal to 0.0 ??C. If this input field is left blank, the default value is 10 ??C.";
		public static string Field_DefrostEnergyInputRatioFunctionOfTemperatureCurveName = @"This alpha field defines the name of a bi-quadratic performance curve (ref: Performance Curves) that parameterizes the variation of the energy input ratio (EIR) during reverse-cycle defrost periods as a function of the wet-bulb temperature of the air entering the indoor coil (variable x) and the outdoor air dry-bulb temperature (variable y). The EIR is the inverse of the COP. The output of this curve is multiplied by the coil capacity, the fractional defrost time period and the runtime fraction of the heating coil to give the defrost power at the specific temperatures at which the indoor and outdoor coils are operating. This curve is only required when a reverse-cycle defrost strategy is selected. The curve is normalized to a value of 1.0 at the rating point conditions.";
		public static string Field_MaximumOutdoorDryBulbTemperatureForDefrostOperation = @"This numeric field defines the outdoor air dry-bulb temperature above which outdoor coil defrosting is disabled. The temperature for this input field must be greater than or equal to 0 ??C and less than or equal to 7.22 ??C. If this input field is left blank, the default value is 5 ??C.";
		...
		public static string Field_ResistiveDefrostHeaterCapacity = @"This numeric field defines the capacity of the resistive defrost heating element in Watts. This input field is used only when the selected defrost strategy is resistive (see input field Defrost Strategy above). The value for this input field must be greater than or equal to 0. If this input field is left blank, the default value is 0.";
		public static string Field_ApplyPartLoadFractionToSpeedsGreaterThan1 = @"This field determines whether part-load impacts on coil energy use are applied when the coil is operating at speeds greater than speed 1. The allowed choices are Yes or No, with the default being No if this field is left blank. Other input fields in this object allow the user to specify a part-load fraction correlation for each speed to account for compressor start up losses (cycle on/off). For the case of a single multi-speed compressor, the part load losses may only be significant when the compressor cycles between speed 1 and off, but the losses may be extremely small when the compressor operates between speed 1 and speed 2 (or between speeds 2 and 3, etc.). In this case, the user may chose to specify {No} for this input field to neglect part-load impacts on energy use at higher operating speeds. If part-load impacts on coil energy use are thought to be significant (e.g., interwined cooling coil with multiple compressors feeding individual refrigerant circuits), then the user may chose to specify {Yes} and the part-load fraction correlations specified for speeds 2 through 4 will be applied as appropriate. The selection for this input field does not affect part-load impacts when the compressor cycles between speed 1 and off (i.e., the part-load fraction correlation for speed 1 is always applied).";
		public static string Field_FuelType = @"This alpha field determines the type of fuel that the chiller uses. This field has seven choices: Electricity, NaturalGas, Propane, Coal, Diesel, Gasoline, FuelOil1, FuelOil2, OtherFuel1 and OtherFuel2. This is a required field with no default.";
...
If the user wishes to model no efficiency degradation due to compressor cycling, the part load fraction correlation should be defined as follows:
       ...
       PLF = 1.0 + 0.0(PLR)";
		public static string Field_SpeedXRatedWasteHeatFractionOfPowerInput = @"The fraction of heat input to heating that is available as recoverable waste heat at full load and rated conditions for Speed <x> operation.";
		...
		public static string Field_ZoneNameForEvaporatorPlacement = @"This input field is name of a conditioned or unconditioned zone where the secondary coil (evaporator) of a heat pump is installed. This is an optional input field specified only when user desires to extract heat from the zone via secondary coil. Heat extracted is modeled as internal gain. If the primary DX system is a heat pump, then the zone name should be the same as the zone name specified for placing the secondary cooling DX coil.";
		public static string Field_SpeedXSecondaryCoilAirFlowRate = @"This input value is the secondary coil (evaporator) air flow rate when the heat pump is working in heating mode or the secondary coil (condenser) air flow rate when the heat pump is working in cooling mode. This input field is auto-sizable.";
		public static string Field_SpeedXSecondaryCoilFanFlowScalingFactor = @"This input field is scaling factor for autosizing the secondary DX coil fan flow rate. The secondary air flow rate is determined by multiplying the primary DX coil rated air flow rate by the fan flow scaling factor. Default value is 1.25. If the secondary coil fan flow rate is not autosized, then the secondary coil fan flow scaling factor is set to 1.0.";
		public static string Field_SpeedXNominalSensibleHeatRatioOfSecondaryCoil = @"This input value is the nominal sensible heat ratio used to split the heat extracted by a secondary DX coil (evaporator) of a heat pump into sensible and latent components. This is an optional input field. If this input field is left blank, then pure sensible internal heat gain is assumed, i.e., sensible heat ratio of 1.0.";
		public static string Field_SpeedXSensibleHeatRatioModifierFunctionOfTemperatureCurveName = @"This input field is name of sensible heat ratio modifier biquadratic curve. The value of this curve modifies the nominal sensible heat ratio for current time step depending on the secondary zone air node wet-bulb temperature and the heating DX coil entering air dry-bulb temperature. This is an optional input field. If this input field is left blank, then the nominal sensible heat ratio modifier curve value for temperature is set to 1.0.";
		public static string Field_SpeedXSensibleHeatRatioModifierFunctionOfFlowFractionCurveName = @"This input field is name of sensible heat ratio modifier curve as function of secondary air flow fraction. The value of this curve modifies the nominal sensible heat ratio for current time step depending on the secondary coil air flow fraction. This is an optional input field. If this input field is left blank, then the sensible heat ratio modifier curve value for flow fraction is set to 1.0.
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the variable speed heating coil.";
		...
		public static string Field_NominalSpeedLevel = @"This numeric field defines the nominal speed level, at which the rated capacity, rated air and volumetric flow rate are correlated.";
		public static string Field_GrossRatedHeatingCapacityAtSelectedNominalSpeedLevel = @"This numeric field contains the rated capacity at the nominal speed level. This field is autosizable. The gross rated heating capacity is used to determine a capacity scaling factor, as compared to the Reference Unit capacity at the nominal speed level.
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for this component.";
		...
		public static string Field_DXCoolingCoilSystemSensorNodeName = @"This alpha field contains the identifying name given to the DX cooling coil control node, this is the node at which the temperature set point is specified by the set point manager.";
		public static string Field_CoolingCoilObjectType = @"This alpha field specifies the type of DX cooling coil. The valid choices for this field are:
  ...
  Coil:Cooling:DX:SingleSpeed:ThermalStorage";
		public static string Field_CoolingCoilName = @"This alpha field contains the identifying name of the DX cooling coil.
...
As shown in the example below, correct specification of this system requires specification of the DX Cooling Coil object in addition to the CoilSystem:Cooling:DX object.";
		public static string Field_DehumidificationControlType = @"This alpha field contains the type of dehumidification control. The following options are valid for this field:
...
";
  ...
  HeatExchanger:Desiccant:BalancedFlow";
		public static string Field_HeatExchangerName = @"This alpha field denotes the name of the air-to-air heat exchanger being modeled.";
		public static string Field_CoolingCoilObjectType = @"This alpha field denotes the type of DX cooling coil being modeled. The only valid choices are Coil:Cooling:DX:SingleSpeed or Coil:Cooling:DX:VariableSpeed.";
		public static string Field_CoolingCoilName = @"This alpha field denotes the name of the DX cooling coil being modeled.
...
HeatExchanger:AirToAir:SensibleAndLatent";
		public static string Field_HeatExchangerName = @"This alpha field denotes the name of the air-to-air heat exchanger being modeled.";
		public static string Field_CoolingCoilObjectType = @"This alpha field denotes the type of chilled-water cooling coil being modeled. Valid choices are:

Coil:Cooling:Water

Coil:Cooling:Water:DetailedGeometry";
		public static string Field_CoolingCoilName = @"This alpha field denotes the name of the chilled-water cooling coil being modeled.
...
";
	public static string Field_Name = @"This alpha field defines a unique user-assigned name for an instance of a heat pump water heater DX coil. Any reference to this coil by another object (e.g., \lstinline!WaterHeater:HeatPump:WrappedCondenser!) will use this name.";
		...
		public static string Field_RatedEvaporatorInletAirDryBulbTemperature = @"This numeric field defines the evaporator inlet air dry-bulb temperature, in degrees Celsius, that corresponds to rated coil performance (heating capacity, COP and SHR). Values must be greater than 5 ??C. If this field is left blank, the default value is 19.7 ??C.";
		public static string Field_RatedEvaporatorInletAirWetBulbTemperature = @"This numeric field defines the evaporator inlet air wet-bulb temperature, in degrees Celsius, that corresponds to rated coil performance (heating capacity, COP and SHR). Values must be greater than 5 ??C. If this field is left blank, the default value is 13.5 ??C.";
		public static string Field_RatedCondenserWaterTemperature = @"This numeric field defines the condenser inlet water temperature, in degrees Celsius, that corresponds to rated coil performance (heating capacity, COP and SHR). Values must be greater than 25 ??C. If this field is left blank, the default value is 57.5 ??C.";
		public static string Field_RatedEvaporatorAirFlowRate = @"This numeric field defines the evaporator air volume flow rate in cubic meters per second at rated conditions. Values must be greater than 0. If this field is left blank or autocalculated (field value = {autocalculate}), the default value is 5.035E-5 m^{3}/s/W (31.25 cfm/MBH) multiplied by the Rated Heating Capacity specified above. When autocalculating the rated evaporator air volumetric flow rate, a zone sizing object is not required.";
		public static string Field_EvaporatorFanPowerIncludedInRatedCOP = @"This choice field specifies if evaporator fan power is included in the rated COP defined above. This input impacts the calculation of compressor electric power and total air cooling provided by the evaporator for each simulation timestep. If Yes is selected, the evaporator fan power is subtracted from the total electric heating power when calculating total evaporator cooling capacity. If No is selected, it is assumed that the total heating power does not include evaporator fan power. If this field is left blank, the default is Yes. See the Engineering Reference section for \lstinline!Coil:WaterHeating:AirToWaterHeatPump:\*! for further details.";
		public static string Field_EvaporatorAirInletNodeName = @"This alpha field defines the name of the air node from which the evaporator coil draws its inlet air.";
		public static string Field_EvaporatorAirOutletNodeName = @"This alpha field defines the name of the air node to which the evaporator coil sends its outlet air.";
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the coil. Any reference to this coil by another object (e.g., AirLoopHVAC:UnitaryHeatPump:WaterToAir) will use this name.";
		...
		public static string Field_NominalCoolingCoilCapacity = @"This numeric field defines the nominal cooling capacity for the WatertoAirHP cooling coil in Watts.";
		public static string Field_NominalTimeForCondensateRemovalToBegin = @"This numeric field defines the nominal time (in seconds) after startup for condensate to begin leaving the coil's condensate drain line at the coil's rated airflow and temperature conditions, starting with a dry coil. Nominal time is equal to the ratio of the energy of the coil's maximum condensate holding capacity (J) to the coil's steady-state latent capacity (W). Suggested value is 1000; zero value means the latent degradation model is disabled. The default value for this field is zero.";
		public static string Field_RatioOfInitialMoistureEvaporationRateAndSteadyStateLatentCapacity = @"This numeric field defines ratio of the initial moisture evaporation rate from the cooling coil (when the compressor first turns off, in Watts) and the coil's steady-state latent capacity (Watts) at rated airflow and temperature conditions. Suggested value is 1.5; zero value means the latent degradation model is disabled. The default value for this field is zero.";
		public static string Field_HighPressureCutoff = @"This numeric field defines the compressor s maximum allowable pressure in Pascal (N/m2)";
		public static string Field_LowPressureCutoff = @"This numeric field defines the compressor s minimum allowable pressure in Pascal (N/m2)";
		...
		public static string Field_AirOutletNodeName = @"This alpha field contains the cooling coil air outlet node name.";
		public static string CoolingCoilParameters = @"Depending on the type of compressor and the source side fluid specified, the type of parameters and values also differs. An Excel Spreadsheet is developed to estimate the parameters based on the manufacturer data. The general parameters are listed first followed by specific parameters required by the respective compressor model. Lastly, parameters are listed based on the type of source side fluid used.";
		public static string Field_LoadSideTotalHeatTransferCoefficient = @"This numeric field defines the estimated parameter {load side total heat transfer coefficient} in W/K. This field was previously known as Parameter 1.";
		public static string Field_LoadSideOutsideSurfaceHeatTransferCoefficient = @"This numeric field defines the estimated parameter {load side outside surface heat transfer coefficient} in W/K. This field was previously known as Parameter 2.";
		public static string Field_SuperheatTemperatureAtTheEvaporatorOutlet = @"This numeric field defines the estimated parameter {superheat temperature} at the evaporator outlet in ??C. This field was previously known as Parameter 3.";
		public static string Field_CompressorPowerLosses = @"This numeric field defines the estimated parameter {compressor power losses}, which accounts for the loss of work due to mechanical and electrical losses in the compressor in Watts. This field was previously known as Parameter 4.";
		public static string Field_CompressorEfficiency = @"This numeric field defines the estimated parameter of the {compressor s efficiency}. The compressor efficiency is formulated as the equation below:
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the coil. Any reference to this coil by another object (e.g., AirLoopHVAC:UnitaryHeatPump:WaterToAir) will use this name.";
		...
		public static string Field_AirInletNodeName = @"This alpha field contains the cooling coil air inlet node name.";
		public static string Field_AirOutletNodeName = @"This alpha field contains the cooling coil air outlet node name.";
		public static string Field_RatedAirFlowRate = @"This numeric field contains the rated volumetric air flow rate on the load side of the heat pump in m3/s. This field is autosizable.";
		public static string Field_RatedWaterFlowRate = @"This numeric field contains the rated volumetric water flow rate on the source side of the heat pump in m3/s. This field is autosizable.";
		...
		public static string Field_GrossRatedSensibleCoolingCapacity = @"This numeric field contains the gross rated sensible capacity of the heat pump in W. This field is autosizable. The gross rated sensible cooling capacity shouldnot account for the effect of supply air fan heat.";
		public static string Field_RatedCoolingCoefficientOfPerformance = @"This numeric field contains the rated cooling coefficient of performance of the heat pump.";
		public static string Field_TotalCoolingCapacityCoefficient1To5 = @"These numeric fields contain the first to fifth coefficient for the heat pump total cooling capacity.";
		public static string Field_SensibleCoolingCapacityCoefficient1To6 = @"These numeric fields contain the first to sixth coefficient for the heat pump sensible cooling capacity.";
		public static string Field_CoolingPowerConsumptionCoefficient1To5 = @"These numeric fields contain the first to fifth coefficient for the heat pump power consumption.";
		public static string Field_NominalTimeForCondensateRemovalToBegin = @"This numeric field defines the nominal time (in seconds) after startup for condensate to begin leaving the coil's condensate drain line at the coil's rated airflow and temperature conditions, starting with a dry coil. Nominal time is equal to the ratio of the energy of the coil's maximum condensate holding capacity (J) to the coil's steady-state latent capacity (W). Suggested value is 1000; zero value means the latent degradation model is disabled. The default value for this field is zero.";
		public static string Field_RatioOfInitialMoistureEvaporationRateAndSteadyStateLatentCapacity = @"This numeric field defines ratio of the initial moisture evaporation rate from the cooling coil (when the compressor first turns off, in Watts) and the coil's steady-state latent capacity (Watts) at rated airflow and temperature conditions. Suggested value is 1.5; zero value means the latent degradation model is disabled. The default value for this field is zero.
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the variable speed cooling coil. Any reference to this coil by another object (e.g., AirLoopHVAC:UnitaryHeatPump:WaterToAir) will use this name.";
		...
		public static string Field_AirOutletNodeName = @"This alpha field contains the cooling coil load side outlet node name.";
		public static string Field_NumberOfSpeeds = @"This numeric field contains the maximum number of speed levels that the module uses. The number of speeds, for which the user input the performance data and curves, should be equal or higher than the maximum number. The performance inputs at higher speed levels are ignored.";
		public static string Field_NominalSpeedLevel = @"This numeric field defines the nominal speed level, at which the rated capacity, rated air and water volumetric flow rates are correlated.";
		public static string Field_GrossRatedTotalCoolingCapacityAtSelectedNominalSpeedLevel = @"This numeric field contains the gross rated total cooling capacity at the nominal speed level. This field is autosizable. The gross rated total cooling capacity is used to determine a capacity scaling factor, as compared to the Reference Unit capacity at the nominal speed level.
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the coil. Any reference to this coil by another object (e.g., AirLoopHVAC:UnitaryHeatPump:WaterToAir) will use this name.";
		...
		public static string Field_RefrigerantType = @"This alpha field contains the type of refrigerant used by the heat pump.";
		public static string Field_DesignSourceSideFlowRate = @"This numeric field defines the water flow rate though the coil in m3/sec";
		public static string Field_GrossRatedHeatingCapacity = @"This numeric field defines the gross heating capacity for the WatertoAirHP heating coil at the rated condition in Watts. The gross heating capacity should Not inlcude the ffect of supply air fan heat.";
		public static string Field_HighPressureCutoff = @"This numeric field defines the compressor s maximum allowable pressure in Pascal (N/m2)";
		public static string Field_LowPressureCutoff = @"This numeric field defines the compressor s minimum allowable pressure in Pascal (N/m2)";
		...
		public static string Field_AirOutletNodeName = @"This alpha field contains the heating coil air outlet node name.";
		public static string HeatingCoilParameters = @"Depending on the type of compressor specified, the type of parameters and values also differs. An Excel Spreadsheet is in the final stage of development that is capable of estimating the parameters based on the manufacturer data. The general parameters are listed first followed by specific parameters required by the respective compressor model. Lastly, parameters are listed based on the type of source side fluid used.";
		public static string Field_LoadSideTotalHeatTransferCoefficient = @"This numeric field defines the estimated parameter {load side total heat transfer coefficient} in W/K. This field was previously known as Parameter 1.";
		public static string Field_SuperheatTemperatureAtTheEvaporatorOutlet = @"This numeric field defines the estimated parameter {superheat temperature} at the evaporator outlet in ??C. This field was previously known as Parameter 2.";
		public static string Field_CompressorPowerLosses = @"This numeric field defines the estimated parameter {compressor power losses}, which accounts for the loss of work due to mechanical and electrical losses in the compressor in Watts. This field was previously known as Parameter 3.";
		public static string Field_CompressorEfficiency = @"This numeric field defines the estimated parameter of the {compressor s efficiency}. The compressor efficiency is formulated as the equation below:
...
This field was previously know as Parameter 4.";
		...
		public static string Field_RefrigerantVolumeFlowRate = @"This numeric field defines the {refrigerant volume flow rate} at the beginning of the compression [m3/s]. This field was part of what was previously known as Parameter 6. It should only be used when the Compressor type is Scroll. The field should be left blank when Compressor type is Reciprocating or Rotary.";
		public static string Field_VolumeRatio = @"This numeric field defines the {built-in-volume ratio}. This field was part of what was previously known as Parameter 6. It should only be used when the Compressor type is Scroll. The field should be left blank when Compressor type is Reciprocating or Rotary.";
		...
		public static string Field_SourceSideHeatTransferCoefficient = @"This numeric field defines the estimated parameter {source side heat transfer coefficient} in W/K. This field was part of what was previously known as Parameter 8. It should only be used when the Source Side Fluid Name is Water.";
		...
		public static string Field_SourceSideHeatTransferResistance2 = @"This numeric field defines the estimated {parameter source side heat transfer resistance 2}. Unit is W/K. This field was previously known as Parameter 9. It should only be used when the Source Side Fluid Name is an antifreeze.
...
";
	public static string Field_Name = @"This alpha field contains the identifying name for the coil. Any reference to this coil by another object (e.g., AirLoopHVAC:UnitaryHeatPump:WaterToAir) will use this name.";
		...
		public static string Field_RatedAirFlowRate = @"This numeric field contains the rated volumetric air flow rate on the load side of the heat pump in m3/s. This field is autosizable.";
		public static string Field_RatedWaterFlowRate = @"This numeric field contains the rated volumetric water flow rate on the source side of the heat pump in m3/s. This field is autosizable.";
		public static string Field_GrossRatedHeatingCapacity = @"This numeric field contains the gross heating capacity of the heat pump at the rated condition in W. The gross heating capacity should not account for the effect of supply air fan heat. This field is autosizable.";
		public static string Field_GrossRatedHeatingCOP = @"This numeric field contains the gross rated heating coefficient of performance of the heat pump. The gross rated COP of the heat pump should not account for the effect of supply air fan heat.";
		public static string Field_HeatingCapacityCoefficient15 = @"These numeric fields contain the first to fifth coefficient for the heat pump capacity.";
...
PLF = 0.85 + 0.0 \times PLR
\end{equation}";
		public static string Field_GroupRatedSpecificationPerformanceCurvesAndWasteHeatData = @"The performance for each heating speed must be specified as shown below. They should be directly given from the Reference Unit data. All inputs for Speed 1 are required, followed by the optional inputs for other speeds.";
...
\end{array}
\end{equation}";
		public static string Field_SpeedXRatedWasteHeatFractionOfPowerInput = @"The fraction of heat input to heating that is available as recoverable waste heat at full load and rated conditions for Speed <x> operation. The part of heat is not delivered to the indoor side.";
...
This field is autocalulatable. When autocalculated, the design flow rate is determined using the sizing factor in the following input field.";
		public static string Field_CondenserAirFlowSizingFactor = @"This field is used if the previous input field is set to autocalculate. This sizing factor is multiplied by the Rated Evaporator Air Flow Rate to obtain a scaled value for Condenser Design Air Flow Rate, in m^{3}/s. If this field is left blank the default value is 1.0.";
		public static string Field_CondenserType = @"This field is the type of condenser used by the TES coil. There are two options, {AirCooled} or {EvaporativelyCooled}. The default is AirCooled. The next six put fields are used when the condenser section is evaporatively cooled.";
		public static string Field_EvaporativeCondenserEffectiveness = @"This field is the wetbulb effectiveness for the evaporatively-cooled condenser. The effectiveness is used to model the temperature of air exposed to the condenser section as follows:
...
This field is required if the condenser type is set to EvaporativelyCooled. If the field is left blank then a default of 0.7 is used.";
		...
		public static string Field_StorageTankPlantConnectionInletNodeName = @"This is the name of a system node that is the inlet to the TES tank. This field is optional and is only used if the TES tank is directly connected to a plant loop.";
		public static string Field_StorageTankPlantConnectionOutletNodeName = @"This is the name of a system node that is the inlet to the TES tank. This field is optional and is only used if the TES tank is directly connected to a plant loop.";
		public static string Field_StorageTankPlantConnectionDesignFlowRate = @"This field is the design flow rate for the plant connection to the TES tank, in m^{3}/s. The TES tank will make a passive request for this amount of flow. This field is required if the storage tank is connected to plant.";
		public static string Field_StorageTankPlantConnectionHeatTransferEffectiveness = @"This field specifies the heat transfer effectiveness between the plant connection and the TES tank. If the effectiveness is set to 1 then ideal heat transfer occurs, as if the fluids were completely mixed and the fluid leaving the tank is the same temperature as the tank. If the effectiveness is less than 1.0, then the leaving fluid temperature approaches that of the tank as would be the case with a heat exchanger. If left blank, the default is 0.7.";
		public static string Field_StorageTankMinimumOperatingLimitFluidTemperatureC = @"This field is used for fluid-based TES tank (Storage Type of Water or UserDefinedFluidType) to set the a lower limit on the operating temperatures, in Degrees Celsius. This value represents the temperature of the fluid-based TES tank when fully charged. This field is optional. When left blank, the model uses the lowest temperature for which fluid properties are defined.";
...
";
  ...
  MinimumMassFlowRate Minimum mass flow rate of fluid at node (kg/s)";
		public static string Field_ScheduleName = @"The name of a schedule whose values are to be used as setpoints on the node or node list. The schedule value for each time period is the setpoint for this type of setpoint manager. The schedule must have values that are in the appropriate units as defined in the previous field.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of this scheduled setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
  ...
  MinimumTemperature";
		public static string Field_SetpointAtOutdoorLowTemperature = @"The supply air temperature setpoint in ^{o}C at the outdoor low temperature for the first reset rule.";
		public static string Field_OutdoorLowTemperature = @"The outdoor air low temperature in ^{o}C for the first supply air temperature reset rule. Generally, at this outdoor air temperature the supply temperature is at its maximum.";
		public static string Field_SetpointAtOutdoorHighTemperature = @"The supply air temperature setpoint in ^{o}C at the outdoor high temperature for the first reset rule.";
		public static string Field_OutdoorHighTemperature = @"The outdoor air high temperature in ^{o}C for the first supply air temperature reset rule. Generally, at this outdoor air temperature the supply temperature is at its minimum.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.";
		public static string Field_ScheduleName = @"The name of a schedule whose values indicate which reset rule to use. Schedule values of 1 indicate that the first reset rule will be used. Schedule values of 2 select the second reset rule.";
		public static string Field_SetpointAtOutdoorLowTemperature2 = @"The supply air temperature setpoint in ^{o}C at the outdoor low temperature for the second reset rule.";
		public static string Field_OutdoorLowTemperature2 = @"The outdoor air low temperature in ^{o}C for the second supply air temperature reset rule. Generally, at this outdoor air temperature the supply temperature is at its maximum.";
		public static string Field_SetpointAtOutdoorHighTemperature2 = @"The supply air temperature setpoint in ^{o}C at the outdoor high temperature for the second reset rule.";
		public static string Field_OutdoorHighTemperature2 = @"The outdoor air high temperature in ^{o}C for the second supply air temperature reset rule. Generally, at this outdoor air temperature the supply temperature is at its minimum.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of this setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		public static string Field_ControlVariable = @"The type of variable that will be controlled. There is only one choice for this type of setpoint manager: Temperature.";
		public static string Field_MinimumSupplyAirTemperature = @"The minimum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager).";
		public static string Field_MaximumSupplyAirTemperature = @"The maximum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager)";
		public static string Field_ControlZoneName = @"The name of the control zone for this single zone reheat system. The heating or cooling load for this zone determines the supply air temperature setpoint.";
		public static string Field_ZoneNodeName = @"The name of the zone node for the control zone.";
		public static string Field_ZoneInletNodeName = @"The name of the zone inlet node that is supplying air to the control zone.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of a single zone heating setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_MinimumSupplyAirTemperature = @"The minimum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager).";
		public static string Field_MaximumSupplyAirTemperature = @"The maximum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager)";
		public static string Field_ControlZoneName = @"The name of the control zone for this setpoint manager. The heating load for this zone (to meet the zone heating setpoint) determines the supply air temperature setpoint.";
		public static string Field_ZoneNodeName = @"The name of the zone node for the control zone.";
		public static string Field_ZoneInletNodeName = @"The name of the zone inlet node that is supplying air to the control zone.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of a single zone cooling setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_MinimumSupplyAirTemperature = @"The minimum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager).";
		public static string Field_MaximumSupplyAirTemperature = @"The maximum supply air temperature (in ^{o}C) that is allowed for this system (as set by this setpoint manager)";
		public static string Field_ControlZoneName = @"The name of the control zone for this setpoint manager. The cooling load of this zone (to meet the zone cooling set point) determines the supply air temperature setpoint.";
		public static string Field_ZoneNodeName = @"The name of the zone node for the control zone.";
		public static string Field_ZoneInletNodeName = @"The name of the zone inlet node that is supplying air to the control zone.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a Node List object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of a mixed air setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_FanOutletNodeName = @"The name of the supply fan outlet node.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name where temperature setpoints will be established by this setpoint manager. The node name(s) specified here cannot be the same as the Reference Setpoint Node Name in the previous field.";
		public static string Field_CoolingCoilInletNodeName = @"The name of the cooling coil inlet node.";
		public static string Field_CoolingCoilOutletNodeName = @"The name of the cooling coil outlet node.";
		public static string Field_MinimumTemperatureAtCoolingCoilOutletNode = @"In order to prevent cooling coil freezing during economizer operation, the minimum temperature at the cooling coil outlet is required based on requirement of ASHRAE Standard 90.1. The default value is 7.2C.
...
The system node properties listed above are all available as an Output:Variable to facilitate tracking these setpoints both at the reference node and the setpoint nodes.";
		public static string Field_MinimumSetpointTemperature = @"The minimum temperature (in ^{o}C) that is allowed by this setpoint manager. Applicable only if Control variable is Temperature.";
		public static string Field_MaximumSetpointTemperature = @"The maximum temperature (in ^{o}C) that is allowed by this setpoint manager. Applicable only if Control variable is Temperature.";
		public static string Field_MinimumSetpointHumidityRatio = @"The minimum humidity ratio (kgWater/kgDryAir) that is allowed by this setpoint manager. Applicable only if Control variable is MaximumHumidityRatio, MinimumHumidityRatio, or HumidityRatio. Note that zero is not allowed as the computed setpoint humidity ratio, because zero is used as a special value to indicate that no humidification or dehumidification is needed. If the reference humidity ratio setpoint value is zero, the zero value will be passed directly to the Set Point Node(s).";
		public static string Field_MaximumSetpointHumidityRatio = @"The maximum humidity ratio (kgWater/kgDryAir) that is allowed by this set point manager. Applicable only if Control variable is MaximumHumidityRatio, MinimumHumidityRatio, or HumidityRatio.";
		public static string Field_ReferenceSetpointNodeName = @"The name of an HVAC system node where the desired mixed air condition has been set. Normally this would be the mixed air node leaving the OutdoorAir:Mixer. The temperature or humidity setpoint at this reference node must be set by a different setpoint manager of the appropriate type (see Control Variable above).";
		public static string Field_MixedAirStreamNodeName = @"The name of the mixed air node. This node is used to obtain the flow rate of the combined air stream. This node is usually the same node at the Reference Setpoint Node Name, but does not have to be.";
		public static string Field_OutdoorAirStreamNodeName = @"The name of a node in the outdoor air stream. This node is used to obtain the flow rate of the outdoor air stream.";
		public static string Field_ReturnAirStreamNodeName = @"The name of a node in the return air stream. This node is used to obtain the flow rate of the return air stream.";
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of a warmest setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_MaximumSetpointTemperature = @"The maximum allowed setpoint temperature in degrees C. If the calculated setpoint is greater than this value the setpoint is set to the maximum. This value is also used as the setpoint temperature when none of the zones have a cooling load.";
		public static string Field_Strategy = @"Currently, the only choice for this field is MaximumTemperature.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of a coldest setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_MaximumSetpointTemperature = @"The maximum allowed setpoint temperature in degrees C. If the calculated setpoint is greater than this value the setpoint is set to the maximum.";
		public static string Field_Strategy = @"Currently, the only choice for this field is MinimumTemperature.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of an Return Air Bypass Flow setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_TemperatureSetpointScheduleName = @"The name of a schedule whose values are temperatures in ^{o}C. The schedule value for the time period is the setpoint for this type of setpoint manager. The setpoint is assumed to be at the air handler outlet.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of this setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_MinimumSetpointTemperature = @"The minimum allowed setpoint temperature in degrees C. If the calculated setpoint temperature is less than this minimum, the setpoint is set to the minimum.";
		public static string Field_MaximumSetpointTemperature = @"The maximum allowed setpoint temperature in degrees C. If the calculated setpoint is greater than this value the setpoint is set to the maximum. This value is also used as the setpoint temperature when none of the zones have a cooling load.";
		public static string Field_Strategy = @"The choices for this field are {TemperatureFirst} and {FlowFirst}. See discussion above for a description of what each strategy does.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which temperature setpoints will be established by this setpoint manager.";
		public static string Field_MinimumTurndownRatio = @"The minimum value of the ratio of the actual air flow rate to the maximum air flow rate, either for the supply fan if there are no VAV terminal boxes, or for the VAV boxes if present. If there are VAV boxes, it is assumed that the same value of minimum turndown applies to all boxes.
...
";
	public static string Field_Name = @"A unique, user-assigned name for an instance of an average minimum humidity (humidifying) multizone setpoint manager. Anywhere in the input that this setpoint manager is used, it is referred to by this name.";
		...
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes, or the HVAC System Node Name, for which humidity ratio setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique user-defined name for an instance of this setpoint manager.";
		...
		public static string Field_MaximumSetpointTemperature = @"This field provides an upper limit to the resulting setpoint value.";
		public static string Field_MinimumSetpointTemperature = @"This field provides a lower limit to the resulting setpoint value.";
		public static string Field_SetpointNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which setpoints will be established by this setpoint manager.
...
";
	public static string Field_Name = @"A unique user-defined name for an instance of this setpoint manager.";
		...
		public static string Field_OffsetTemperatureDifference = @"This field provides a temperature offset that will be applied to the value obtained from the reference system node. If this value is zero, and the limits are met, then the resulting setpoint will be exactly the same as the reference system node temperature. The sign convention is that a positive value here will increase the resulting setpoint to higher than the temperature at the reference node.";
		public static string Field_MaximumLimitSetpointTemperature = @"This field provides an upper limit to the resulting setpoint value.";
		public static string Field_MinimumLimitSetpointTemperature = @"This field provides a lower limit to the resulting setpoint value.";
		public static string Field_SetpointSystemNodeOrNodeListName = @"The name of a NodeList object containing the names of the HVAC system nodes or the HVAC System Node Name for which setpoints will be established by this setpoint manager.
...
NF = Normalized condenser water flow per unit of tower capacity, m3/s-W";
		public static string Field_MinimumOutsideAirWetbulbTemperatureCurveName = @"The curve name associated with the coefficients in the equation used to determine the minimum actual wetbulb referenced by the optimized condenser entering water temperature curve. The value from this curve is compared the actual outside wet bulb each timestep to establish one of the governing boundaries over the optimized condenser entering water temperature setpoint calculation. This curve must be quad-linear (Curve:QuadLinear) and is defined as:
...
NF = Normalized condenser water flow per unit of tower capacity, m3/s-W";
		public static string Field_OptimizedCondenserEnteringTemperatureCurveName = @"The curve name associated with the coefficients in the optimized condenser entering water temperature equation. The value from this curve is used to calculate the optimized condenser entering water temperature for each timestep. If this optimized setpoint does not fall within the bounds established by the two boundary conditions, then the value from the Default Condenser Entering Water Temperature Schedule is used for the Condenser Entering Water Setpoint for that timestep. This curve must be quad-linear (Curve:QuadLinear) and is defined as:
...
NF = Normalized condenser water flow per unit of tower capacity, m3/s-W";
		...
		public static string Field_MaximumCondenserEnteringTemperature = @"This field establishes the maximum condenser entering water setpoint temperature allowed. If the scheduled or calculated setpoint is above TCondEntMax, then TCondEntSetpoint is reset to equal TCondEntMax. The units for this field are deg C.";
		public static string Field_CoolingTowerDesignInletAirWetBulbTemperature = @"This field defines the reference wet bulb temperature used to size the cooling tower. Typically, the design condenser entering water temperature equals TwrRefOaWb + TowerApproachTD. The units for this field are deg C.";
		public static string Field_SetpointNodeOrNodeListName = @"This field defines the condenser node being controlled.
...
";
	public static string Field_Name = @"This alpha field is a unique, user-assigned name for an instance of a single zone one stage cooling setpoint manager.";
		...
		public static string Field_SetpointNodeOrNodeListName = @"This alpha field is the name of a NodeList objet containing the names of the HVAC system nodes, or the name of a system node, for which temperature setpoints will be established by this setpoint manager.
