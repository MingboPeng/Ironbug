...
{
    public class Ironbug_EnergyManagementSystemInternalVariables : Ironbug_Component, IGH_VariableParameterComponent
    {
        protected override System.Drawing.Bitmap Icon => null;

        public override Guid ComponentGuid => new Guid("48AEAAD1-2346-4989-9F86-27DEA57B5DAF");
        private IEnumerable<string> OutputVariables { get; set; } = new List<string>();

        public Ironbug_EnergyManagementSystemInternalVariables()
          : base("Ironbug_EnergyManagementSystemInternalVariables", "EmsInternalVariables",
              "Description",
        ...
        {
            pManager.AddGenericParameter("InternalVariables", "InternalVariables", "Connect to Ironbug component's _param input to get each object's available InternalVariables", GH_ParamAccess.item);
        }
        ...
        private List<HVAC.IB_EnergyManagementSystemInternalVariable> CollectOutputVariable()
        {
            var outputVariables = new List<HVAC.IB_EnergyManagementSystemInternalVariable>();
            ...
            foreach (var item in allInputParams)
            {
                ...
                else
                {
                    ...
                    if (!((fristData == null) || String.IsNullOrWhiteSpace(fristData.ToString())))
                    {
                        ...
                        {
                            var inVar = new HVAC.IB_EnergyManagementSystemInternalVariable();
                            inVar.SetTrackingID(value);
                            inVar.SetInternalDataType(item.Name);
                            outputVariables.Add(inVar);
                        }
                    }
                }
            }
        ...
        protected override void AppendAdditionalComponentMenuItems(ToolStripDropDown menu)
        {
            ...
            var t = new ToolStripMenuItem("EMS InternalVariables");
        ...
        public void GetEPOutputVariables(object sender, EventArgs e)
        {
            ...
            {
                this.OutputVariables = ibObj.EmsInternalVariables;
            }
        }
