...
//{
//    public class Ironbug_EnergyManagementSystemActuators : Ironbug_Component, IGH_VariableParameterComponent
//    {
//        protected override System.Drawing.Bitmap Icon => null;

//        public override Guid ComponentGuid => new Guid("A01CB374-7370-40A0-9DDD-B6879645C4BF");
...
//        {
//            pManager.AddGenericParameter("Actuators", "Actuators", "Connect to Ironbug component's _param input to get each object's available Actuators", GH_ParamAccess.item);
//        }
...
//        private List<HVAC.IB_EnergyManagementSystemActuator> CollectOutputVariable()
//        {
...
//                        {
//                            var ctrlType = item.Name;
//                            var comType = this._emsActuators[ctrlType];
//                            var actuator = new HVAC.IB_EnergyManagementSystemActuator();
//                            var fieldSet = HVAC.IB_EnergyManagementSystemActuator_FieldSet.Value;
//                            actuator.AddCustomAttribute(fieldSet.ActuatedComponentType, comType);
//                            actuator.AddCustomAttribute(fieldSet.ActuatedComponentControlType, ctrlType);
//                            actuator.SetTrackingID(value);
...
//            var t = new ToolStripMenuItem("EMS Actuators");
//            this.GetEPOutputVariables(this, EventArgs.Empty);
//            var allParams = this._emsActuators.ToList();
            
//            var inputParams = this.Params.Input.Select(_ => _.Name).ToList();
//            allParams.Sort();
//            foreach (var item in allParams)
//            {
//                var ctrlType = item.Key;
//                var mitem = Menu_AppendItem(t.DropDown, ctrlType, OnClickParam, true, inputParams.Any(_ => _ == ctrlType));
//            }
//            if (allParams.Any()) {
//                menu.Items.Add(t);
//            }
...
//            {
//                this._emsActuators = ibObj.EmsActuators;
//            }
//        }
