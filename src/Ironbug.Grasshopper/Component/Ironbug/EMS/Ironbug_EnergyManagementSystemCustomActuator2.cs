...
{
    public class Ironbug_EnergyManagementSystemCustomActuator2 : Ironbug_Component
    {
        public Ironbug_EnergyManagementSystemCustomActuator2()
          : base("Ironbug_EnergyManagementSystemCustomActuator2", "EMSCustomActuator",
              "Description",
