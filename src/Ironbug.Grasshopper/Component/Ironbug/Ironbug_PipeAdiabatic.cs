...
{
    public class Ironbug_PipeAdiabatic : Ironbug_HVACComponentBase
    {
        ...
        {
            pManager.AddGenericParameter("PipeAdiabatic", "PipeAdiabatic", "PipeAdiabatic", GH_ParamAccess.item);
        }
