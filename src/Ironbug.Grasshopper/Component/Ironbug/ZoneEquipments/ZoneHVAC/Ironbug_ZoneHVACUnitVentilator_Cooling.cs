...
{
    public class Ironbug_ZoneHVACUnitVentilator_Cooling : Ironbug_HVACWithParamComponent
    {
        
        /// Initializes a new instance of the Ironbug_ZoneHVACUnitHeater class.
        
        public Ironbug_ZoneHVACUnitVentilator_Cooling()
          : base("IB_ZoneHVACUnitVentilator_Cooling", "UnitVentCooling",
              "Description",
        ...
        {
            pManager.AddGenericParameter("CoolingCoil", "coilC_", "Cooling coil to provide cooling source. It has to be CoilCoolingWater.", GH_ParamAccess.item);
