...
namespace Ironbug.Grasshopper.Component
{
    public class Ironbug_ZoneHVACLowTempRadiantVarFlow : Ironbug_HVACWithParamComponent
    {
        ...
        public Ironbug_ZoneHVACLowTempRadiantVarFlow()
          : base("IB_ZoneHVACLowTempRadiantVarFlow", "RadiantVFlow",
              "Description",
        ...
        {
            pManager.AddGenericParameter("ZoneHVACLowTempRadiantVarFlow", "Radiant", "Connect to zone's equipment", GH_ParamAccess.item);
        }
